<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="them.aspx.cs" Inherits="btlltweb.qllophoc.them" %>
...
<  <body style="display: grid;">
            ...
            <div class="grid">
                <div id="menu__mega">
                  ...
                  <div id="content__body" class="thang">
                      ...
                      <h1 class="h1">Thêm Lớp Học</h1>
       <form id="form1" runat="server" >
             <div class="form-group">
        <label asp-for="MaSinhVien">Mã Lớp Học</label>
        <asp:TextBox ID="ml" runat="server" class="form-control"></asp:TextBox>
    </div>
    <div class="form-group">
    ...
    <div class="btn-group">
            ...
            <asp:Button ID="Button1" runat="server" Text="Thêm Lớp Học " Width="173px" OnClick="Button1_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
