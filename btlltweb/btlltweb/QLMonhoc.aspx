<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QLMonhoc.aspx.cs" Inherits="btlltweb.QLMonhoc" %>
        ...
        <div class="main__web">
            <div class="grid">
                <div id="menu__mega">
                  ...
                  <asp:Label ID="Label1" runat="server" Text="Danh sách môn học" Width="100%" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ; margin-top:20px;  " ></asp:Label>
           ...
           <div class="trai">
            <asp:GridView ID="dgvMonHoc" runat="server" Height="305px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellPadding="4" Style =" margin-top: 10px; margin-bottom:10px; " Width="100%" AutoGenerateColumns="False" ForeColor="#333333" GridLines="None" >
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="SoTinChi" HeaderText="Số Tín Chỉ" SortExpression="SoTinChi" />
                </Columns>
            ...
            <asp:Button ID="Button1" runat="server" Text="Nạp Môn Học " Width="173px" OnClick="Button1_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
     
            <asp:Button ID="Button2" runat="server" Text="Thêm Môn Học " Width="173px" OnClick="Button2_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
       
            <asp:Button ID="Button3" runat="server" Text="Sửa Môn Học " Width="173px" OnClick="Button3_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
           
            <asp:Button ID="Button4" runat="server" Text="Xóa Môn Học " Width="173px" OnClick="Button4_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
           </div>
<div class="phai">
    <table border="0" style="width: 100%">
        <tr>
            <td><asp:Label ID="Label2" runat="server" Text="Mã môn học:"></asp:Label></td>
             <td><asp:TextBox ID="txtMamonhoc" class="text2"  runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td><asp:Label ID="Label3" runat="server" Text="Tên môn học:"></asp:Label></td>
            <td><asp:DropDownList ID="cbomonhoc" class="text2" runat="server" AutoPostBack="True">
                
                </asp:DropDownList></td>
        </tr>
        <tr>
            <td><asp:Label ID="Label6" runat="server" Text="Số tín chỉ:"></asp:Label></td>
             <td><asp:TextBox ID="txtsotinchi" class="text2" runat="server"></asp:TextBox></td>
        </tr>
    </table>
