<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xoa.aspx.cs" Inherits="btlltweb.qlmonhoc.xoa" %>
...
<  <body style="display: grid;">
    ...
    <div class="btn-group">
            ...
            <asp:Button ID="Button1" runat="server" Text="Xóa Môn Học " Width="173px" OnClick="Button1_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
