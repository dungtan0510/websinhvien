<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sua.aspx.cs" Inherits="btlltweb.qlgiaovien.sua" %>
...
<  <body style="display: grid;">
                ...
                <div id="menu__mega">
                 <nav class="main__menu">
                  ...
                  <div id="content__body" class="thang">
                      ...
                      <h1 class="h1">Sửa Giáo Viên</h1>
       <form id="form1" runat="server" >
             <div class="form-group">
        <label asp-for="MaSinhVien">Mã Giáo Viên</label>
       <asp:DropDownList ID="Mgv" runat="server"  class="form-control" AutoPostBack="True" OnSelectedIndexChanged="Msv_SelectedIndexChanged"></asp:DropDownList>
    </div>
    <div class="form-group">
    ...
    <div class="btn-group">
            ...
            <asp:Button ID="Button1" runat="server" Text="Sửa Giáo Viên " Width="173px" OnClick="Button1_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
