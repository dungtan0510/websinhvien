<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="them.aspx.cs" Inherits="btlltweb.qlgiaovien.them" %>
...
<  <body style="display: grid;">
                ...
                <div id="menu__mega">
                 <nav class="main__menu">
                  ...
                  <div id="content__body" class="thang">
                      ...
                      <h1 class="h1">Thêm Giáo Viên</h1>
       <form id="form1" runat="server" >
             <div class="form-group">
        <label asp-for="MaSinhVien">Mã Giáo Viên</label>
        <asp:TextBox ID="Mgv" runat="server" class="form-control"></asp:TextBox>
    </div>
    <div class="form-group">
    ...
    <div class="btn-group">
            ...
            <asp:Button ID="Button1" runat="server" Text="Thêm Giáo Viên " Width="173px" OnClick="Button1_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
