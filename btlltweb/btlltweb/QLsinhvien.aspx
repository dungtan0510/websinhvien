<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QLsinhvien.aspx.cs" Inherits="btlltweb.QLsinhvien" %>
    ...
    <header id="header">
        ...
        <div class="main__web">
            <div class="grid">
                ...
                <nav class="main__menu">
                  ...
                  <asp:Label ID="Label1" runat="server" Text="Danh sách sinh viên" Width="100%" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ; margin-top:20px;  " ></asp:Label>
       ...
       <form id="form1" runat="server">
           <div class="trai">
            ...
            <asp:Button ID="Button1" runat="server" Text="Nạp Sinh Viên " Width="173px" OnClick="Button1_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
     
            <asp:Button ID="Button2" runat="server" Text="Thêm Sinh Viên " Width="173px" OnClick="Button2_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
       
            <asp:Button ID="Button3" runat="server" Text="Sửa Sinh Viên " Width="173px" OnClick="Button3_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
           
            <asp:Button ID="Button4" runat="server" Text="Xóa Sinh Viên " Width="173px" OnClick="Button4_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
           </div>
<div class="phai">
    <table border="0" style="width: 100%">
        <tr>
            <td><asp:Label ID="Label2" runat="server" Text="Mã sinh viên:"></asp:Label></td>
             <td><asp:TextBox ID="txtMaSinhVien" class="text2" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
        ...
        <tr>
            <td><asp:Label ID="Label6" runat="server" Text="Lớp Học:"></asp:Label></td>
            <td><asp:DropDownList ID="cboLop" class="text2" runat="server" AutoPostBack="True"></asp:DropDownList></td>
        </tr>
    </table>
