<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xoa.aspx.cs" Inherits="btlltweb.qlsinhvien.xoa" %>
...
<  <body style="display: grid;">
    ...
    <div class="form-group">
       ...
       <asp:TextBox ID="ns" runat="server" class="form-control"  ></asp:TextBox>
    </div>
    <div class="form-group">
        <label asp-for="GioiTinh">Giới tính</label>
        <asp:TextBox ID="gt" runat="server" class="form-control" ></asp:TextBox>
    </div>
    <div class="form-group">
    ...
    <div class="btn-group">
            ...
            <asp:Button ID="Button1" runat="server" Text="Xóa Sinh Viên " Width="173px" OnClick="Button1_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
