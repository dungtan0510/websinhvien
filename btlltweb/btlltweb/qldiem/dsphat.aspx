<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dsphat.aspx.cs" Inherits="btlltweb.qldiem.dsphat" %>
        ...
        <div class="main__web">
            <div class="grid">
                <div id="menu__mega">
                  ...
                  <asp:Label ID="Label1" runat="server" Text="Danh sách kỉ luật" Width="100%" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ; margin-top:20px;  " ></asp:Label>
