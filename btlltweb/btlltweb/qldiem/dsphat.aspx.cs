...
{
    public partial class dsphat : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = @"SELECT DIEM.MaSinhVien, SINH_VIEN.HoVaTen, MON_HOC.MaMonHoc, DIEM.LanHoc, DIEM.LanThi, DIEM.Diem
                           FROM SINH_VIEN INNER JOIN (MON_HOC INNER JOIN DIEM ON MON_HOC.MaMonHoc = DIEM.MaMonHoc) ON SINH_VIEN.MaSinhVien = DIEM.MaSinhVien Where  Diem < 4";
