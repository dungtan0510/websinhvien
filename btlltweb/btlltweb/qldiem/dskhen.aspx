<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dskhen.aspx.cs" Inherits="btlltweb.qldiem.dskhen" %>
        ...
        <div class="main__web">
            <div class="grid">
                <div id="menu__mega">
                  ...
                  <asp:Label ID="Label1" runat="server" Text="Danh sách khen thưởng" Width="100%" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ; margin-top:20px;  " ></asp:Label>
                  <div id="content__body">
       <form id="form1" runat="server">
           <div class="trai">
            <asp:GridView ID="dgvMonHoc" runat="server" Height="305px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellPadding="4" Style =" margin:20px; " Width="1200px" AutoGenerateColumns="False" ForeColor="#333333" GridLines="None" >
                ...
                <asp:Button ID="Button1" runat="server" Text="Quay lại " Width="173px" OnClick="Button1_Click" Style="background-color:#2851b2 ; text-align:center; color : white; padding : 5px ;  margin: 20px; "/>
           </div>
<div class="phai">
